...
const { addAProperty,updateAproperty,asignPropertyToAtenant,getAllProperties,deleteAProperty,vacateATenantFromAProperty,getApropertyById, bulkDeleteProperties, restoreProperty, testRateLimitter } = require("../controllers/propertyController");
...
router.patch("/property/restore/:propertyId", verifyUserToken, checkUserRole(["Admin"]), restoreProperty)
